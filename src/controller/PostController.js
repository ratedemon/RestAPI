...
export default class PostController {
    ...
    async removeImage(ctx) {
        try {
            ...
            const imageDelete = new Promise((resolve, reject) => {
            ...
            const promises = await Promise.all([postImage, imageDelete]);

            if(!promises[0].includes(1) || !promises[1].includes(1)){
                return ctx.status = 404;
            }
